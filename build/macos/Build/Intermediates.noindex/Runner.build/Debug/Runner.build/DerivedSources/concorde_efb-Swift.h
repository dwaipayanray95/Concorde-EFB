...
#ifndef CONCORDE_EFB_SWIFT_H
#define CONCORDE_EFB_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="concorde_efb",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSApplication;
SWIFT_CLASS("_TtC12concorde_efb11AppDelegate")
...
SWIFT_CLASS("_TtC12concorde_efb17MainFlutterWindow")
