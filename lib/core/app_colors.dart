...
class AppColors extends ThemeExtension<AppColors> {
  ...
  static const light = AppColors(
    bg: Color(0xFFE4E9F4),
    surface: Color(0xFFD6DEEE),
    resultsBg: Color(0xFFFFFFFF),
    inputBg: Color(0xFFFFFFFF),
    textPrimary: Color(0xFF0F121C),
    textSecondary: Color(0xFF424A60),
    textDim: Color(0xFF5E6780),
    divider: Color(0xFFBDC7DA),
    dividerStrong: Color(0xFFA8B4CE),
