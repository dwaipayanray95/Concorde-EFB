...
class _FlightPlannerTabState extends State<FlightPlannerTab> {
  ...
  Widget _buildSubTabButton(
    ...
    final activeBg = colors.accent;
    final activeText = const Color(0xFF090B10);

    return Material(
      color: Colors.transparent,
      child: InkWell(
        onTap: () => setState(() => _activeSubTab = index),
        hoverColor: isSelected ? null : colors.resultsBg.withValues(alpha: 0.4),
          ...
          child: Row(
            ...
            children: [
              Icon(
                icon,
                size: 14,
                color: isSelected ? activeText : colors.textDim,
              ),
